...
GLint Steps = 6;                    // to change steps
GLint RaysPerStep =15;
GLint DropsPerRay = 150;
GLfloat DropsComplete = Steps * RaysPerStep * DropsPerRay;
GLfloat AngleOfDeepestStep = 70;
...
glBegin(GL_QUADS);
//glColor3ub(0.2,0.7,0.3);
//glColor3ub(2.09,51.5,3.03);  
glColor3ub(1.0,150.0,2.00);                      // to chenge ground color
...
for (int j = 1; j < 3; j++)
{
if (j == 1) glColor3f(1.3,10.5,10.2);
...
glLoadIdentity();
glClearColor(0.5f,1.0f,1.0f,0.0);               //background
...
if(vflag==3)
{
if(xangle<=80.0)      // top view rotate
xangle += 10.0;
}
if(vflag==33)
{
...
glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
glLoadIdentity();
glClearColor(1,1,0.6,1.0);
glTranslatef(0.0,0.0,-6.0);
glTranslatef(0.0,-1.3,0.0);
glColor3f(0.5,0.2,0.5);
DrawTextXY(-2.7,3.5,0.0,0.003," HELP ");          //purple
glColor3f(0.5,0.1,1);
DrawTextXY(-1.75,2.4,0.0,0.0014," Keyboard Controls : ");         //blue
glColor3f(1.0,0.1,0.5); 
DrawTextXY(-1.25,2.1,0.0,0.001," Move Near -> N ");
DrawTextXY(-1.25,1.9,0.0,0.001," Move Away -> A ");
DrawTextXY(-1.25,1.5,0.0,0.001," Move Up -> U ");           //pink
...
DrawTextXY(-4.7,3.5,0.0,0.0020," CHANNABASAVESHWARA INSTITUTE OF TECHNOLOGY ");   //green
glColor3f(0.5,0.2,0.5);
DrawTextXY(-3.7,2.8,0.0,0.0015," MINI PROJECT ON GRAPHICAL IMPLEMENTATION OF ");     //purple
glColor3f(0.0,0.1,0.9);
DrawTextXY(-1.75,2.1,0.0,0.0014," FLOWING FOUNTAIN ");                              //blue
glColor3f(0.7,0.6,0.1);
DrawTextXY(-3.25,1.5,0.0,0.001," Submitted by :- ");
glColor3f(1,0.1,0.5);
DrawTextXY(-2.5,1.2,0.0,0.001," HARSHITHA.K ");
DrawTextXY(-2.5,0.95,0.0,0.001," BINDU.R ");                                       //pink
glColor3f(1,0.1,0.5);
DrawTextXY(-1.005,1.2,0.0,0.001," (1CG15CS031) ");
DrawTextXY(-1.005,0.95,0.0,0.001," (1CS15CS019) ");
glColor3f(0.7,0.6,0.1);
DrawTextXY(-1.25,0,0.0,0.001," Under the guidance of : ");
glColor3f(1.0,0.0,0.2);
DrawTextXY(0.2,-.2,0.0,0.001,"  Dharanesh kumar M.L");                           //red
DrawTextXY(0.3,-.4,0.0,0.001," Assistant Prof.of CSE ");
DrawTextXY(0.3,-.6,0.0,0.001," CIT GUBBI");
glColor3f(0.3,0.3,0.3);
DrawTextXY(2.3,-1,0.0,0.0008," Press any key... ");
glFlush();
glutSwapBuffers();
}
